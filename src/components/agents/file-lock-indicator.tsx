  ...
  if (locks.length === 0) {
    return (
      <Card>
        ...
        <CardContent>
          <p className="text-sm text-muted-foreground">No files are currently locked. All files available.</p>
        </CardContent>
      </Card>
    );
  }
          ...
          >
            <div className="min-w-0 flex-1">
              ...
              <p className="text-xs text-muted-foreground mt-0.5">
                Held by <span className="text-blue-600 font-medium">{lock.agent_name}</span>
              </p>
            </div>
